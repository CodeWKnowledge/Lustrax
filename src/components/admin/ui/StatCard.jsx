...
const StatCard = ({ label, value, icon, trend, trendValue, color = 'gold' }) => {
  return (
    <div className="bg-white p-4 md:p-6 lg:p-8 rounded-2xl border-subtle flex flex-col justify-between group hover:shadow-premium-hover transition-luxury">
      ...
      <div className="space-y-0.5 lg:space-y-2">
        <p className="text-[8px] lg:text-[9px] font-bold uppercase tracking-[0.4em] text-gray-400">{label}</p>
